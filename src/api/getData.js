...
// 默认获取车辆列表
export const teamTree = (companyCode ) => fetch('/api/alarm/teamTree',{
    companyCode
})
...
//默认综合统计列表
export const alarmCompsStat = (companyCode,teamCode,startDate,endDate) => fetch('/api/alarm/alarmCompsStat',{
    companyCode,teamCode,startDate,endDate
})
...
//查询默认统计列表
export const deriverAlarmCount = (pageNum,pageSize,companyCode, teamCode,startDate,endDate,gategory) => fetch('/api/alarm/alarmStat',{
