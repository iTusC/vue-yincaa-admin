				...
				<div id="large-header" class="large-header" style="height:100%">
					...
					<div class="logo_box">
						...
						<form action="#" name="f" method="post">
							...
							<div class="mb2">
								<el-button type="primary" @keyup.enter.native="submit" @click="submit" @keyup.native="submit" style="width:400px;height:50px;color: #FFFFFF;border-radius:30px;" :loading="log">登录</el-button>
							</div>
						</form>
					</div>
				</div>
...
export default {
    ...
    methods: {
        ...
        //设置cookie
        setCookie(c_name, c_id, c_path, exdays) {
        ...
        async logins(params) {
            ...
            if (res.code == 0) {
                ...
                this.$options.methods.setCookie(
